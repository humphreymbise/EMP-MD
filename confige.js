...
module.exports = {
  ...
  // Bot Identity
  BOT_NAME: process.env.BOT_NAME || 'HGM_bug-MD',
  OWNER_NAME: process.env.OWNER_NAME || 'Zezetech',
  OWNER_NUMBER: process.env.OWNER_NUMBER || '255682937675',

  // Behavior Toggles
  PREFIX: process.env.PREFIX || '.',
  AUTO_REPLY: toBool(process.env.AUTO_REPLY),
  AUTO_REPLY_MSG: process.env.AUTO_REPLY_MSG || 'Thank for choosing EMP-MD🥰ENJOYING.',
  ...
  ANTICALL_MSG: process.env.ANTICALL_MSG || '⚔️⚔️not interested ',
